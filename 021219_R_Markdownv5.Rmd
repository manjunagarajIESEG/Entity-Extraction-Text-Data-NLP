...
We can say that the model performs well on the given type (job description) of unstructured text. However, it is heavily dependent on the structure of these descriptions. Therefore, further developments or improvements should focus on generalisation. Furthermore, we were able to extract company names from the texts but did not have a chance to categorize them based on the industries. Getting top 5 industries that actively use data science will help us make better decisions when we apply for jobs.
